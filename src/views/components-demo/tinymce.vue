<template>
  <div class="components-container">
    <code>
      ...
      <a target="_blank" class="link-type" href="https://panjiachen.github.io/vue-element-admin-site/zh/feature/component/rich-editor.html#tinymce"> {{$t('components.documentation')}}</a>
    </code>
    <div>
