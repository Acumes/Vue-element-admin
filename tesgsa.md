...
| 里程碑编号 | 里程碑说明 | 资金 | 预计时间 | 
| ----- | ----- | ----- |----- |
| 1 | Finalize scope, a list of node API endpoints to be used, workflow design, architectural design & UI mockups | 2000$ | 2-3周 |
| 2 | Implementation interoperable with a Filecoin node, Wallet can be created and operated | 6000$ | 3-4周 |
| 3 | Provide toolkit generated by wallet local client for developers. | 2000$ | 1周 |
| 4 | All project deliverables are completed and added to the Filecoin Shipyard (website, documentation, codebase) | 3000$ | 2周 |
| 5 | Maintenance and Upgrades during Testnet and Mainnet | 3000$ | 2-3周 |
## Acceptance Criteria
